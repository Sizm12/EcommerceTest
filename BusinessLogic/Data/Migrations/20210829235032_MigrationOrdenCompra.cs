        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionEnvio_Id = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemOrder_ProductoItemId = table.Column<int>(type: "int", nullable: true),
                    ItemOrder_ProductoNombre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemOrder_ImagenUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Precio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_OrdenCompras_OrdenCompraId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrdenCompraId",
                table: "OrderItems",
