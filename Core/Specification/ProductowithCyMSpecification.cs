...
{
    public class ProductowithCyMSpecification : BaseSpecification<Producto>
    {
        public ProductowithCyMSpecification(ProductoSpecificationParams productoParams) 
            : base(x => 
        ...
        public ProductowithCyMSpecification(int id) : base(x => x.Id == id)
        {
            AddInclude(p => p.Categoria);
            AddInclude(p => p.Marca);
        }
